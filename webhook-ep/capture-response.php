...
if(!empty($response))
{
    switch($response->type) {
        ...
        case "customer.created":
            ...
            $param["email"] = $response->data->object->email;
            $stripePayment->insertCustomer($param);
            break;

        case "customer.subscription.created":
            $param = array();
            $param["stripe_subscription_id"] = $response->data->object->id;            
            $param["stripe_customer_id"] = $response->data->object->customer;
        ...
        case "invoice.created":
            ...
            $param["stripe_subscription_id"] = $response->data->object->subscription;            
            $param["stripe_customer_id"] = $response->data->object->customer;
